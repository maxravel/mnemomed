...
const pomodoroR = document.querySelector("#pomodoroReset");
...
//for working when you are in different sites (if last session started less than 30 minutes ago)
    ...
    pomodoroC.textContent = (localStorage.getItem("pomodoroValue") - ((Date.now()-parseInt(localStorage.getItem("pomodoroSession")))-(Date.now()-parseInt(localStorage.getItem("pomodoroSession")))%1000)/1000);
    pomodoroCInt = (localStorage.getItem("pomodoroValue") - ((Date.now()-parseInt(localStorage.getItem("pomodoroSession")))-(Date.now()-parseInt(localStorage.getItem("pomodoroSession")))%1000)/1000);
...
pomodoroR.addEventListener("click",function(){
    if(localStorage.getItem("pomodoroValue")){
        pomodoroC.textContent = localStorage.getItem("pomodoroValue")/60;
        pomodoroCInt = localStorage.getItem("pomodoroValue")/60;
    };
    ...
    subtract5min.disabled = false; 
    localStorage.removeItem("pomodoroPause"); 
    localStorage.removeItem("pomodoroPauseStartTime"); 
    localStorage.removeItem("pomodoroSession");
    localStorage.removeItem("pomodoroValue"); 
})